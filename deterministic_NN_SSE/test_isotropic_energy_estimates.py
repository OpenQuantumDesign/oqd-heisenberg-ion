...
with open(out_file, 'w') as f:
    ...
    for i1 in range(len(T_list)):
        ...
        energy_array, energy_mean, energy_error, spectrum_offset = SSE_sim.simulate_isotropic(N, M_init, equilibration_steps, mc_steps, sites, beta, interaction_type, boundary_conditions)
...
plt.legend()
plt.savefig("Results/N_{}_{}_isotropic_{}.png".format(N, interaction_type, boundary_conditions))