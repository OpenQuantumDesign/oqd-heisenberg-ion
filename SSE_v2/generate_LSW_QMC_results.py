...
h = 0.0
alpha_list = []
alpha_list_2 = [round(0.0 + i*0.1,2) for i in range(51)]
...
plt.errorbar(alpha_list, np.array(energy_SSE_1_list), np.array(energy_SSE_1_err_list), fmt='None', capsize=5, color='C0')
...
plt.errorbar(alpha_list, np.array(energy_SSE_2_list), np.array(energy_SSE_2_err_list), fmt='None', capsize=5, color='C0')
plt.scatter(alpha_list, np.array(energy_SSE_3_list), label=r'$Classical$', color='C3')
plt.errorbar(alpha_list, np.array(energy_SSE_3_list), np.array(energy_SSE_3_err_list), fmt='None', capsize=5, color='C3')
...
plt.legend()
plt.xlabel(r"$\alpha$", fontsize=16)
plt.ylabel(r"$\frac{E_{0}^{Exact}}{E_{0}^{Approx.}}$", fontsize=16, rotation='horizontal', ha='right')
...
plt.errorbar(alpha_list, np.array(stiffness_SSE_1_list), np.array(stiffness_SSE_1_err_list), fmt='None', capsize=5, color='C0')
plt.scatter(alpha_list, np.array(lsw_stiffness_2), label='LSW', color='C3')
plt.plot(alpha_list, [large_alpha_lsw_rho] * len(alpha_list), color='green', linestyle='dashed', label=r'LSW($\alpha \rightarrow \infty$)')
plt.plot(alpha_list, [1.0/np.pi] * len(alpha_list), color='black', linestyle='dashed', label=r'FFS')
#plt.plot(alpha_list, [mft_E0/N] * len(alpha_list), color='black', linestyle='dashed', label=r'MFT')
#plt.plot(alpha_list, [lmg_E0/N] * len(alpha_list), color='green', linestyle='dashed', label=r'LMG')
...
plt.errorbar(alpha_list, np.array(stiffness_SSE_3_list), np.array(stiffness_SSE_3_err_list), fmt='None', capsize=5, color='C3')
plt.scatter(alpha_list, np.array(stiffness_SSE_4_list), label=r'$LSW$', color='C0')
plt.errorbar(alpha_list, np.array(stiffness_SSE_4_list), np.array(stiffness_SSE_4_err_list), fmt='None', capsize=5, color='C0')
...
plt.legend()
plt.xlabel(r"$\alpha$", fontsize=16)
plt.ylabel(r"$\frac{\rho_s^{Exact}}{\rho_s^{Approx.}}$", fontsize=16, rotation='horizontal', ha='right')
