...
N = 11
T_list = ["5.0", "2.0", "1.0", "0.5", "0.333", "0.25", "0.2", "0.167", "0.143", "0.122", "0.111", "0.1", "0.0909", "0.0833", "0.0769", "0.0714", "0.0666", "0.0625", "0.0588", "0.0555", "0.0526", "0.05"]
...
for i in range(len(beta_ED_list_2)):
    ...
    second_derivative = (free_energy_theta/N + free_energy_minus_theta/N - 2.0*free_energy_zero/N)/(theta**2)
    spin_stiffness = second_derivative
    stiffness_ED_list_2.append(spin_stiffness)

    energy_ED_list_2.append(energy_zero/N)
...
ax1.text(alpha_identifier_locs[alpha][0], alpha_identifier_locs[alpha][1], 
         r'$\alpha={}$'.format(alpha), fontsize=14, bbox=dict(facecolor='w'))
